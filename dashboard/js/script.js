...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ============================================
  // Обработчик для ссылки .modal_funds
  // ============================================

  const modalFunds = document.querySelector('.modal_funds');
  if (modalFunds) {
    modalFunds.addEventListener('click', function(e) {
      e.preventDefault();

      console.log('✅ Клик по .modal_funds сработал'); // для проверки
